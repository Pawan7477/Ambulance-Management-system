...
using namespace std;
//-------------------------------blink Text-------------------
void blinkText(const string& text){
    while(true){
        cout<<"\r"<<text;
        Sleep(500);
...
void customer_detail::put_cust(){
    cout<<setw(6)<<cust_id<<setw(15)<<cust_name<<setw(10)<<cust_phone<<setw(15)<<cust_address<<endl;
...
void Hospital_detail::put_hosp(){
    cout<<setw(1)<<hospn_code<<setw(20)<<hospid<<setw(20)<<hosp_name<<setw(20)<<hosp_address<<setw(20)<<hosp_phone<<endl;
...
void Ambulance_detail::put_ambul(){
    cout<<setw(1)<<ambpn_code<<setw(20)<<ambid<<setw(20)<<amb_name<<setw(20)<<amb_drive<<setw(20)<<amb_phone<<endl;
}
//-----------------------------------------------Function Declartion--------------------------------------------------------
